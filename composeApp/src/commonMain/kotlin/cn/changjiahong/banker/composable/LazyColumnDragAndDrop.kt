...
fun LazyColumnDragAndDrop() {
    var list by remember { mutableStateOf(List(3) { it }) }
    ...
    LazyColumn(
        ...
        itemsIndexed(list, key = { _, item -> item }) { index, item ->
            DraggableItem(dragDropState, index) { isDragging ->
                ...
                Card(
                    modifier = Modifier.shadow(elevation, RoundedCornerShape(12.dp), clip = false)
//                        .clip(RoundedCornerShape(12.dp))
//                    border = if (isDragging) BorderStroke(2.dp, Color.Blue) else null
                ) {
